...
#%% ===== MODEL SETUP  =====
user_info = {'name':'David Rounce',
            'institution':'Carnegie Mellon University, Pittsburgh PA',
            'email':'drounce@cmu.edu'}
main_directory = '/Users/btober/Documents/pygem_data/'
# Output directory
...
if option_calibration == 'HH2015':
    ...
    emulator_fp = output_directory + 'emulator/'
...
output_sim_fp = output_directory + 'simulations/'
