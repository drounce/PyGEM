...
#                    
#                    #%%
##                    # ------ RANDOM RUNS FOR TIME PURPOSES -------
##                    # Temperature bias
##                    tbias_zlow = (tbias_bndlow - tbias_mu) / tbias_sigma
##                    tbias_zhigh = (tbias_bndhigh - tbias_mu) / tbias_sigma
##                    tbias_random = stats.truncnorm.rvs(a=tbias_zlow, b=tbias_zhigh, loc=tbias_mu,
##                                                       scale=tbias_sigma, size=pygem_prms.mcmc_sample_no)
##                    if debug:
##                        print('\ntbias random:', tbias_random.mean(), tbias_random.std())
##                    
##                    # Precipitation factor
##                    kp_random = stats.gamma.rvs(kp_gamma_alpha, scale=1/kp_gamma_beta, size=pygem_prms.mcmc_sample_no)
##                    if debug:
...
##                                                         scale=pygem_prms.ddfsnow_sigma, size=pygem_prms.mcmc_sample_no)
##                    if debug:    
##                        print('ddfsnow random:', ddfsnow_random.mean(), ddfsnow_random.std(),'\n')
##                    
##                    # Run through random values
##                    for nsim in range(pygem_prms.mcmc_sample_no):
...
##                        meltyrs = run_emulator_meltyrs(modelprms)
