...
#rgi_glac_number = ['00001', '00002', '00003', '03473', '03733']
...
def main(list_packed_vars):
    ...
    print('UPDATE MODEL PARAMS FILEPATH WITH NEW RESULTS!')
    ...
    if option_bias_adjustment == 1:
        ...
        main_glac_bias_adj_colnames = ['RGIId', 'ref', 'GCM', 'rcp_scenario', 'temp_adj', 'prec_adj', 'ref_mb_mwea', 
                                       'ref_vol_change_perc', 'gcm_mb_mwea', 'gcm_vol_change_perc']
...
#            modelparameters['precfactor'] = 0.97811896046
#            modelparameters['precgrad'] = 0.000218488104989
#            modelparameters['ddfsnow'] = 0.003815541
#            modelparameters['ddfice'] = modelparameters['ddfsnow']/0.7
#            modelparameters['tempchange'] = 0.0398049985232
            print(modelparameters)
            glac_idx_t0 = glacier_area_t0.nonzero()[0]

            # For uncalibrated glaciers, load neighbor, since need the adjustments
            ...
            if icethickness_t0.max() > 0:  
                ...
                print(main_glac_rgi.loc[glac,'RGIId'], 'no ice thickness')
...
if __name__ == '__main__':
    ...
    print('CHECK RESULTS ARE CORRECT FOR 15-00001 AND ANOTHER COUPLE GLACIERS')
    ...
    for gcm_name in gcm_list:
        ...
        # Parallel processing
        if (args.option_parallels != 0) and (main_glac_rgi_all.shape[0] > args.num_simultaneous_processes):
