...
#%%=== Model testing ===============================================================================
netcdf_output = nc.Dataset(input.main_directory + '/../Output/PyGEM_output_rgiregion15_ERAInterim_calSheanMB_nearest_20180306.nc', 'r+')
#netcdf_output = nc.Dataset(input.main_directory + '/../Output/PyGEM_output_rgiregion14_ERAInterim_calSheanMB_transferAvg_20180306.nc', 'r+')
...
#plt.plot(years,volume_reg_annual)
#plt.ylabel('Volume [km3]')
#plt.show()
#plt.plot(month,runoff_reg_monthly)
#plt.ylabel('Runoff [m3 / month]')
#plt.show()
...
#plt.legend()
#plt.show()
#plt.plot(years[0:16], massbaltotal_reg_annual, label='massbal_total')
#plt.plot(years[0:16], acc_reg_annual, label='accumulation')
#plt.plot(years[0:16], refreeze_reg_annual, label='refreeze')
#plt.plot(years[0:16], -1*melt_reg_annual, label='melt')
#plt.ylabel('annual regional mean [m.w.e.]')
#plt.legend()
#plt.show()
#
...
ytick = 1
# Plot regional maps
plot_latlonvar(lons, lats, massbal_total_mwea, -1.5, 0.5, 'Geodetic mass balance [mwea]', 'longitude [deg]', 
...
data = pd.read_csv(input.main_directory + '/../Output/calibration_R14_20180313_Opt01solutionspaceexpanding.csv')
#data = pd.read_csv(input.main_directory + '/../Output/calibration_R15_20180306_Opt01solutionspaceexpanding.csv')
