...
if run_eb and ref_gcm_name == 'ERA5':
    ...
    era5h_sp_fn = 'ERA5_sp_hourly.nc'
    era5h_tcc_fn = 'ERA5_tcc_hourly.nc'
    era5h_surfrad_fn = 'ERA5_SWin_hourly.nc'
    ...
    assert os.path.exists(era5h_fp + era5h_uwind_fn), 'ERA5 windspeed filepath does not exist'
    assert os.path.exists(era5h_fp + era5h_vwind_fn), 'ERA5 windspeed filepath does not exist'
