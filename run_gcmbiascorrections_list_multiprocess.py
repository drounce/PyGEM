...
#rgi_glac_number = ['00001', '00002', '03473']
...
filename_modelparams = 'calibration_R15_20180403_Opt02solutionspaceexpanding_wnnbrs_20180520.csv'
...
def main(gcm_name):
    ...
    if option_bias_adjustment == 1:
        ...
        main_glac_bias_adj_colnames = ['RGIId', 'ref', 'GCM', 'rcp_scenario', 'temp_adj', 'prec_adj', 'ref_vol_change', 
                                       'ref_vol_change_perc', 'gcm_vol_change', 'gcm_vol_change_perc']
        ...
        main_glac_bias_adj['RGIId'] = main_glac_rgi['RGIId']
        ...
        for glac in range(main_glac_rgi.shape[0]):
            ...
            # Glacier data
            glac_rgi_idx = main_glac_modelparams.index.values[glac]
            glacier_rgi_table = main_glac_rgi.loc[glac, :]
            glacier_area_t0 = main_glac_hyps.iloc[glac,:].values.astype(float)
            icethickness_t0 = main_glac_icethickness.iloc[glac,:].values.astype(float)
            width_t0 = main_glac_width.iloc[glac,:].values.astype(float)
            modelparameters = main_glac_modelparams.loc[glac_rgi_idx,modelparams_colnames]
            ...
            main_glac_bias_adj.loc[glac, ['ref_vol_change', 'ref_vol_change_perc']] = (
                    [glac_wide_volume_loss_total_ref, glac_wide_volume_loss_total_ref_perc])
            ...
            main_glac_bias_adj.loc[glac, ['gcm_vol_change', 'gcm_vol_change_perc']] = (
                    [glac_wide_volume_loss_total_gcm, glac_wide_volume_loss_total_gcm_perc])
...
if __name__ == '__main__':
    ...
    if args.option_parallels != 0:
        ...
        for n_gcm in range(len(gcm_list)):
            ...
            glac_wide_volume_loss_total_ref_perc = main_vars['glac_wide_volume_loss_total_ref_perc'] 
            glac_wide_volume_loss_total_gcm_perc = main_vars['glac_wide_volume_loss_total_gcm_perc'] 
