...
#                print(year, 'max ice thickness [m]:', icethickness_t0.max())
            ...
            if (input.timestep == 'monthly') and (glac_idx_t0.shape[0] != 0):      
                ...
                for month in range(0,12):
                    ...
                    bin_melt = bin_meltglac + bin_meltrefreeze + bin_meltsnow
                    
#                    glac_bin_melt[glac_idx_t0,step] = (
#                            bin_meltglac[glac_idx_t0,step] + bin_meltrefreeze[glac_idx_t0,step] + 
#                            bin_meltsnow[glac_idx_t0,step]) 
...
#    offglac_wide_acc = calc_glacwide(bin_acc, offglac_bin_area, offglac_wide_area)
    ...
    offglac_wide_runoff = calc_runoff(offglac_wide_prec, offglac_wide_melt, offglac_wide_refreeze, offglac_wide_area)
